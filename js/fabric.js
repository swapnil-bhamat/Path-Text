...
(function () {
    ...
    fabric.util.object.extend(fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
        ...
        setCoords: function () {
            ...
            // padding
                _angle = 0.75          //added this hard code value for fixing the transform tool issue not found any better solution.
...
(function (global) {
    ...
    fabric.Path = fabric.util.createClass(fabric.Object, /** @lends fabric.Path.prototype */ {
        ...
        initialize: function (path, options) {
            ...
            this.top = (this.top == 'undefined' || this.top == null) ? this.minY : this.top;
            this.left = (this.left == 'undefined' || this.left == null) ? this.minX : this.left;
